...
$popMovies = array("Trainspotting","The Dark Knight Rises","Toy Story","The Lion King","The Shawshank Redemption","The Godfather","The Godfather: Part II","The Dark Knight","Pulp Fiction","Schindler's List","12 Angry Men", "Titanic");
...
foreach ($popMovies as $item) {
    ...
    if(strlen($featuredSong)>0) {
        ...
        $parts[] = '("' . $movies . '","' . $imdbID . '",' . $year . ',"' . $rgb . '",' . $rating . ', "' . $themeSong . '", "' . $poster . '","' . $genre . '","' . $plot . '")';
...
$sql = "INSERT INTO moviesPop (name, imdbID, year, color, rating, themeSong, poster, genre, plot) ";
