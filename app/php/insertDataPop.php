...
//goes through the movie array and creates variabels for the attributes
...
foreach ($popMovies as $item) {
    ...
    //Get themesong
    $fixedItemFree = str_replace("+", "%20",$fixedItem )
    ...
    //checks if there is a themesong, otherwise it sets it to empty string
    if(count($result)>0){
